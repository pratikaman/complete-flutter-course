...
class EmailPasswordSignInContents extends ConsumerStatefulWidget {
  const EmailPasswordSignInContents({super.key, this.onSignedIn,
  ...
  @override
  ConsumerState createState() => _EmailPasswordSignInContentsState();
}
...
class _EmailPasswordSignInContentsState extends ConsumerState<EmailPasswordSignInContents> {
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen(emailPasswordSignInControllerProvider(widget.formType).select((state) => state.value), (prevState, state) {
